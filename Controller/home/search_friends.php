...
<img src=<?php echo $head_photo_folder.$user_id."_".$photo_path; ?> style="width:50px; height:50px; float:left; margin-right:6px;" /><span class="name"><?php echo $nick_name; ?></span>&nbsp;<br/><?php echo $flag; ?><br/>
