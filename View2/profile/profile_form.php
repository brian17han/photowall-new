            ...
            <form id="profile_form" action="profile_action.php" method="post" enctype="multipart/form-data" novalidate>
            	<div class="formrow" id="f1">
                    ...
                    <label for="login_name">登录名：</label>
                        ...
                        <div class="login_name">
                        	<p style="margin:0; padding:0; display:inline;">{#$login_name#}</p><a href="#changepwd" style="display:inline; margin:0 0 0 30px; padding:0;"><p style="display:inline-block; margin:0; padding:0;">修改密码</p></a>
                        </div>
                </div>
            	...
            	<div class="formrow" id="f2">
                    ...
                    <label for="nick_name"><font color="red">*</font>昵称：</label>
                        ...
                        <input class="profile_box" type="text" name="nick_name" id="nick_name" placeholder="贴友们所看到的昵称" required/><br/>
                </div>
                ...
                <div style="margin-left:18%; margin-right:auto;" >  
                    <button class="profile_button" type="button" value="submit" onclick="javascript:validationRegister()" ><p style="margin:0px; padding:0px; font-size:1.1em;">保存</p></button>
                </div>
            </form>
		</div>
	</div>
	<?php include '../temp/simplefooter.inc'?>